...
related_milestone: process/07-stage4-users.md
---
...
- **Recommendation:** README row 7 → `process/07-stage4-users.md` → root `USERS.md`; extend instructions for next milestone `08`.
- **Outcome:** [`Documentation/AgentForge/README.md`](../../../README.md), [`process/07-stage4-users.md`](../07-stage4-users.md).
...
- **Created:** `Documentation/AgentForge/process/07-stage4-users.md`
...
- Numbered milestone: [process/07-stage4-users.md](../07-stage4-users.md)

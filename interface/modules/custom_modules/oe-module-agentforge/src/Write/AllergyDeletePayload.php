...
/**
 * G2-Early-22 — allergy soft-delete payload parser. Mirrors VitalsDeletePayload.
 *
 * @package   OpenEMR
...
final class AllergyDeletePayload
{
    private const KEYS = ['allergy_uuid'];
    ...
    public static function parse(?array $payload): array
    {
        ...
        if (!isset($payload['allergy_uuid']) || !is_string($payload['allergy_uuid'])) {
            return [null, 'missing_uuid'];
        }

        $candidate = trim($payload['allergy_uuid']);

...
/**
 * G2-Early-20 — confirmed medication add (lists.type='medication').
 * write_target='medication_add'. Patient-scoped (no encounter binding).
 *
 * @package   OpenEMR
...
[$payload, $payloadError] = MedicationAddPayload::parse(is_array($payloadRaw) ? $payloadRaw : null);
...
$action = new MedicationAddAction(

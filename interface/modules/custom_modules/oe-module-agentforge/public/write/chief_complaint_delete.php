...
/**
 * Confirmed chief-complaint clear (PRD §4.7.4 — clear erroneous reason for visit).
 * write_target = 'chief_complaint_delete'. The encounter row is patched with
 * reason='', and the audit row records the action distinctly from a
 * regular update so post-hoc analysis can tell the two apart.
 *
 * @package   OpenEMR
...
use OpenEMR\Modules\AgentForge\Write\ChiefComplaintDeleteAction;
...
$action = new ChiefComplaintDeleteAction(

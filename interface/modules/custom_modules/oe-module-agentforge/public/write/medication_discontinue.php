...
/**
 * G2-Early-21 — confirmed medication discontinue (soft-delete on lists.type='medication').
 * write_target='medication_discontinue'. Patient-scoped (no encounter binding).
 *
 * @package   OpenEMR
...
use OpenEMR\Modules\AgentForge\Write\OpenEmrPatientMedicationAdapter;
...
[$payload, $payloadError] = MedicationDiscontinuePayload::parse(is_array($payloadRaw) ? $payloadRaw : null);
...
$action = new MedicationDiscontinueAction(
    new OpenEmrPatientMedicationAdapter(),

...
/**
 * G2-Early-23 — confirmed family history add (history_data row append).
 * write_target='family_history_add'. Patient-scoped (no encounter binding).
 *
 * @package   OpenEMR
...
use OpenEMR\Modules\AgentForge\Write\OpenEmrPatientFamilyHistoryAdapter;
...
[$payload, $payloadError] = FamilyHistoryAddPayload::parse(is_array($payloadRaw) ? $payloadRaw : null);
...
$action = new FamilyHistoryAddAction(
    new OpenEmrPatientFamilyHistoryAdapter(),

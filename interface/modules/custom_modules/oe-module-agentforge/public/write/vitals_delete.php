...
/**
 * Confirmed vitals soft-delete (PRD §4.7.4 — void erroneous vitals).
 * write_target = 'vitals_delete'. The row is hidden via forms.activity = 0
 * but preserved in the database for HIPAA-compliant audit trail.
 *
 * @package   OpenEMR
...
use OpenEMR\Modules\AgentForge\Write\OpenEmrEncounterVitalsDeleteAdapter;
use OpenEMR\Modules\AgentForge\Write\VitalsDeleteAction;
use OpenEMR\Modules\AgentForge\Write\VitalsDeletePayload;
...
[$payload, $payloadError] = VitalsDeletePayload::parse(is_array($payloadRaw) ? $payloadRaw : null);
...
$action = new VitalsDeleteAction(
    new OpenEmrEncounterVitalsDeleteAdapter(),

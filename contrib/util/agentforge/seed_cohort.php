...
final class AgentForgeCohortSeeder
{
    ...
    private function seedPatient(array $patientSpec): array
    {
        ...
        return [
            ...
            'first_date' => empty($patientSpec['visits']) ? '—' : $patientSpec['visits'][0]['date'],
            'last_date' => empty($patientSpec['visits']) ? '—' : $patientSpec['visits'][array_key_last($patientSpec['visits'])]['date'],
...
$cohort = [
    ...
    // ----- W2 cohort: new patients (empty charts) ----------------------------
    // Walk in on demo day with intake form (PDF or PNG) and an outside lab.
    // Chart starts empty — intake-form upload populates the chart during the
    // demo. See W2_ARCHITECTURE.md §10 and TASKS.md G2-MVP-05 for context.
    // Sample documents at Documentation/AgentForge/assets/W2-documents/.
    [
        'pubpid' => 'AF-COHORT-011',
        'fname' => 'Margaret',
        'lname' => 'Chen',
        'mname' => 'L.',
        'DOB' => '1967-08-14',
        ...
        'primary_provider' => 'A',
        'theme' => 'W2 new patient (typed PDF intake + outside PDF lipid panel). Empty chart until intake is uploaded. Demo headline patient — smoke asks "should we intensify her statin?" given LDL 158 + T2DM. Source: Chen-Margaret-Intake-Form.pdf.',
        'history' => [],
        'allergies' => [],
        'visits' => af_visits([]),
    ],
    [
        'pubpid' => 'AF-COHORT-012',
        'fname' => 'James',
        'lname' => 'Whitaker',
        'mname' => 'E.',
        'DOB' => '1958-11-03',
        ...
        'state' => 'NM',
        'postal_code' => '87107',
        'phone_cell' => '(505) 555-0193',
        'email' => 'jwhitaker.demo@example.test',
        'primary_provider' => 'A',
        'theme' => 'W2 new patient (typed PDF intake + outside PDF CBC). Empty chart until intake is uploaded. AFib + hyperlipidemia; chief concern is fatigue + dizziness on exertion. Source: Whitaker-James-Intake-Form.pdf.',
        'history' => [],
        'allergies' => [],
        'visits' => af_visits([]),
    ],
    [
        'pubpid' => 'AF-COHORT-013',
        'fname' => 'Sofia',
        'lname' => 'Reyes',
        'mname' => 'M.',
        'DOB' => '1983-12-19',
        'sex' => 'Female',
        'street' => '1124 South Lamar Blvd, Apt 218',
        'city' => 'Austin',
        'state' => 'TX',
        'postal_code' => '78704',
        ...
        'primary_provider' => 'A',
        'theme' => 'W2 new patient (phone-photo PNG intake + phone-photo PNG HbA1c). Empty chart until intake is uploaded. T2DM + mild depression; chief concern is blurry vision + toe numbness ~3 weeks. Source: Reyes-Sofia-Intake-Form.png.',
        'history' => [],
        'allergies' => [],
        'visits' => af_visits([]),
    ],
    [
        'pubpid' => 'AF-COHORT-014',
        'fname' => 'Robert',
        'lname' => 'Kowalski',
        'mname' => 'J.',
        'DOB' => '1971-06-08',
        'sex' => 'Male',
        'street' => '815 N Halsted St',
        'city' => 'Chicago',
        'state' => 'IL',
        'postal_code' => '60614',
        'phone_cell' => '(312) 555-0142',
        'email' => 'rkowalski.demo@example.test',
        'primary_provider' => 'A',
        'theme' => 'W2 new patient (phone-photo PNG intake + outside PDF CMP). Empty chart until intake is uploaded. HTN + hyperlipidemia + alcohol use disorder in remission; chief concern is RUQ pain x 2 days worse after eating. Source: Kowalski-Robert-Intake-Form.png.',
        'history' => [],
        'allergies' => [],
        'visits' => af_visits([]),
    ],
